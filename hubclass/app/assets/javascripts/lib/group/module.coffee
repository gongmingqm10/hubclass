...
.config ['$routeProvider', ($routeProvider) ->
    ...
    .when('/homework/:id', {templateUrl: '/homework/:id', controller: 'GroupHomeworkOriginController'})
    .when('/homework/:homework_id/remark/:submitter_id', {templateUrl: '/homework/:homework_id/remark/:submitter_id', controller: 'GroupHomeworkRemarkController'})
    .when('/homework/:homework_id/submit', {templateUrl: '/homework/:homework_id/submit', controller: 'GroupHomeworkSubmitController'})
